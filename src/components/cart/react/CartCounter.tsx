...
export const CartCounter = ({ quantity = 0 }: Props) => {
  if (!quantity) return <></>

  return (
    <a href="/store/cart" className="relative inline-block">
      <span className='absolute -top-2 -right-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full'>3</span>
